...
def plot_results(pil_img, prob, boxes):
    ...
    for p, (xmin, ymin, xmax, ymax), c in zip(prob, boxes.tolist(), colors):
        ...
        cl = p.argmax()
        print('prob: ', p[cl], '(x, y, x, y): ', xmin, ymin, xmax, ymax, 'label: ', CLASSES[cl])
...
def get_args_parser():
    ...
    parser.add_argument('--img_path', default='', help='image path for inference')
